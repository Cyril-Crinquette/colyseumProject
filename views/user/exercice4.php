...
<div class="container">
    <div class="pt-5 text-white">
        <div class="py-5 mt-5">
            <h1 class="display-4 text-center">Clients fidèles</h1>
            <p class="lead mb-0 text-center">
                Sur cette page, veuillez retrouver la liste de tous les clients du Colyseum possédant une carte de fidélité. <br>
